...
// Script para atualizar as configurações com o novo campo googleMapsEmbed
export const updateSettingsWithGoogleMapsEmbed = async () => {
  try {
    console.log('🔄 Atualizando configurações com campo Google Maps Embed...');
...
if (require.main === module) {
  updateSettingsWithGoogleMapsEmbed()
    .then(() => {
